...
class GenerateIndex
{
    ...
    private function staticRecords(): array
    {
        return [
            ...
            $this->record(
                title: 'Open Source',
                gist: 'PHP packages on Packagist, led by milon/barcode with over 15 million downloads.',
                categories: [],
                link: '/open-source',
                type: 'page',
                dateLabel: '',
            ...
            $this->record(
                title: 'milon/barcode',
                gist: 'Barcode generation for Laravel and plain PHP — SVG, HTML, PNG, and JPEG from TCPDF engines. Over 15 million Packagist downloads.',
                categories: ['open-source', 'php', 'laravel'],
