...
@section('body')
    <h2>Laravel PHP Web Frameworks</h2>
    ...
    <div>
        ...
        <p>
            <img class="book" src="/images/book/cover_2nd_edition.jpg" alt="2nd Edition Cover">
            এবার কথা হচ্ছে কেন লারাভেলের উপর বই লেখার সিদ্ধান্ত নিলাম। প্রায়ই শুনতে হয় নেটে লারাভেলের ভালো কোন বাংলা টিউটোরিয়াল বা রিসোর্স নাই। যা আছে সবই ইংরেজিতে। এছাড়া কমিউনিটি থেকে সারাজীবন বিভিন্ন সাহায্য সহযোগীতা নিয়েই গেলাম, কিন্তু উল্লেখ করার মত কিছুই দিতে পারি নি। তাই এ দায়বন্ধতা থেকেই লারাভেলের উপর বই লিখতে উৎসাহিত হয়েছি।
        </p>
        ...
        <p>
            <strong class="strong">লারাভেল পিএইচপি ওয়েব ফ্রেমওয়ার্ক</strong> <br>
            ISBN: 978-984-33-9190-2
        </p>
        <p>
            <strong class="strong">প্রকাশক:</strong> <br>
            <strong class="strong">দ্বিমিক প্রকাশনী</strong> <br>
            ১ম সংস্করণের প্রকাশ: মে, ২০১৫ <br>
            ২য় সংস্করণের প্রকাশ: আগস্ট, ২০১৬
        </p>
        <p>
            <strong class="strong">প্রাপ্তিস্থান:</strong><br>
            <strong class="strong">হক লাইব্রেরি</strong>, নীলক্ষেত, ঢাকা। (০১৮২০-১৫৭১৮১)<br>
            <strong class="strong">মানিক লাইব্রেরি</strong>, নীলক্ষেত, ঢাকা। (০১৭৩৫-৭৪২৯০৮)
        </p>
        <p>
            <strong class="strong">রকমারি.কম</strong><br>
            <a href="https://www.rokomari.com/book/100634">https://www.rokomari.com/book/100634</a><br>
            ফোন: ১৬২৯৭
        </p>
